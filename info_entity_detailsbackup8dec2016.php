...
<div id="divIdnewprofile" title="Add new profile">
<div id="entities-contain1" align="center">
<form name="new_profile" id="new_profile" action="save_new_profile.php" method="post" enctype="multipart/form-data" onSubmit="return validatenewprofile()"> 
            <table width="98%">
              <tr>
