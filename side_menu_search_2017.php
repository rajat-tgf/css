...
<table class="gridtablefilter">
  ...
  <td><img src="images/team.png" width="18" height="18" align="absmiddle"/></td>
    <td align="left">
      <a href="results_2017.php?all=all" target='contentRightresults2017'>
        Everyone</a></td>
  </tr>
      <?php
	...
	$member = $row_members['name'];
		$result_number_allegations_member = sqlsrv_query($conncss,"SELECT * FROM allegation_details WHERE team_member = '$member' AND status = 'Closed' AND date_received BETWEEN '2017-01-01' AND '2017-12-31'", array(), array( "Scrollable" => 'buffered'));
      ...
      <tr>
        ...
        <td>
          <a href="results.php?member=<?php echo $member ?>&year=2017" target='contentRightresults2017'>
            <?php echo $member; ?>
            (
