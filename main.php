...
<script type="text/javascript">
	...
	function showDialoggrantdetails(grant_number){
	show_grant_details_Popup(grant_number);
	};
...
<div id="divscreeningreport" title="Screening Report Details">
    <iframe id="modalIframeIdal" frameborder="0" width="1400" height="850">
    Your browser is not supported
    </iframe>
</div>     
...
<table align="center">
  <tr>
    <td><strong><font color="#FF0000">* </font>Type of Allegation :</strong></td>
    <td><select name="type_allegation" id="type_allegation" class="text ui-widget-content ui-corner-all">
      <option value="" selected="selected">Reactive</option>
      <option value="Proactive">Proactive</option>
    </select></td>
    <td>&nbsp;</td>
    <td><strong><font color="#FF0000">* </font>Referred from :</strong></td>
    ...
    <td><strong><font color="#FF0000">* </font>Source Category :</strong></td>
  ...
  <tr>
    <td><strong><font color="#FF0000">* </font>Title :</strong></td>
    <td colspan="6"><input name="summary" type="text" id="summary" style="width:100%" maxlength="120" class="text ui-widget-content ui-corner-all"/></td>
  </tr>
  <tr>
...
<div id="reportdivId" title="Monthly Report">                 
    ...
    <?php
    $curr_month = date("m");
    $month = array (1=>"January 2017", "February 2017", "March 2017", "April 2017", "May 2017", "June 2017", "July 2017", "August 2017", "September 2017", "October 2017", "November 2017", "December 2017");
