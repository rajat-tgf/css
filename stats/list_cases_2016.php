...
$result_allegations2016_per_region = sqlsrv_query($conn, "SELECT * FROM cases WHERE creation_date BETWEEN '2016-01-01' AND '2016-12-31'");		
...
function drawBasicopencases() {
		...
		['Regions', 'Cases opened', { role: 'style' }, {type: 'string', role: 'annotation'}],
      ...
      var chart = new google.visualization.BarChart(document.getElementById('chart_regions_open_cases'));
...
<table border="0" align="center">
  <tr>
    <td width="600">
    <div id="chart_regions_open_cases" style='width: 500px; height: 350px'></div></td>
    <td width="6">&nbsp;</td>
    <td width="387" valign="top"><div id="donutchart" style="width: 500px; height: 325px;"></div></td>
  </tr>
</table>
...
<div id="entities-contain" align="center">
      ...
      <tr>
          <td colspan="7">
          <font size="+1"><strong>Total cases opened in 2016: </font><font size="+1"; color="#990000"><?php echo $num_allegations_2016 ?></strong></font><br />
          </td>
      </tr>
        <tr>
          <th>Case</th>
        ...
        <tr>
<?php
$result_allegations2016 = sqlsrv_query($conn, "SELECT * FROM cases WHERE creation_date BETWEEN '2016-01-01' AND '2016-12-31' ORDER BY creation_date ASC");		
...
<td><?php $creation_date = $rowallegations2016['creation_date'];
	echo $creation_date = date('F j, Y', strtotime($creation_date));
	?></td>
<td><?php echo $current_status = $rowallegations2016['current_status'];?></td>
