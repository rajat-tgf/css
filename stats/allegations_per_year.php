...
$allegations_received_2015_open_case_2017 = sqlsrv_query($conncss, "SELECT id FROM allegation_details WHERE resolution = 'Open case in CMS' AND reviewed_by_officer = 'Yes' AND reviewed_by_officer_date BETWEEN '2017-01-01' AND '2017-12-31' AND date_received BETWEEN '2016-01-01' AND '2016-12-31'", array(), array( "Scrollable" => 'buffered'));	
$num_allegations_received_2015_open_case_2017 = sqlsrv_num_rows($allegations_received_2015_open_case_2017);
...
<script type="text/javascript">
							function showDialogintel_reports2017(){
								
							
							   $("#divintel_reports").dialog("open");
							   $("#modalintel_reports").attr("src","stats/list_intel_reports_2017.php");
							   return false;
							}

							$(document).ready(function() {
							   $("#divintel_reports").dialog({
								   show: {
											effect: 'fade',
											duration: 500
										},
...
<tr>
                    ...
                    <tr>
                      ...
                      <a onClick="return showDialogintel_reports2017()">
                      <font size="+1"><strong>
                        <?php
                            echo $num_ir_2017;				
                        ?>
...
<tr>
                    ...
                    <tr>
                      <td align="right"><em>Cases opened in CMS for Investigation in 2017</em></td>
                      <td align="right"><?php echo $num_allegations_received_2015_open_case_2017; ?></td>
                      <td colspan="3" align="center">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right">Referrals to the Secretariat for information only</td>
...
<div id="divproactive" title="Proactive Assessments">
<iframe id="modalproactive" frameborder="0" width="1375" height="850">
Your browser is not supported
</iframe>
</div>

<div id="divintel_reports" title="Intelligence Reports">
<iframe id="modalintel_reports" frameborder="0" width="1375" height="850">
Your browser is not supported
</iframe>
</div>
