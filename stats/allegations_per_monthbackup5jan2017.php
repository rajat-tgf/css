...
function drawVisualization() {
  ...
  var data = google.visualization.arrayToDataTable([
    ...
    ['Jan',  <?php echo $num_allegations_jan_2013 ?>,      <?php echo $num_allegations_jan_2014 ?>,        <?php echo $num_allegations_jan_2015 ?>,        <?php echo $num_allegations_jan_2016 ?>],
    ['Feb',  <?php echo $num_allegations_feb_2013 ?>,      <?php echo $num_allegations_feb_2014 ?>,        <?php echo $num_allegations_jan_2015 ?>,        <?php echo $num_allegations_feb_2016 ?>],
    ['Mar',  <?php echo $num_allegations_mar_2013 ?>,      <?php echo $num_allegations_mar_2014 ?>,        <?php echo $num_allegations_mar_2015 ?>,        <?php echo $num_allegations_mar_2016 ?>],
    ['Apr',  <?php echo $num_allegations_apr_2013 ?>,      <?php echo $num_allegations_apr_2014 ?>,        <?php echo $num_allegations_apr_2015 ?>,        <?php echo $num_allegations_apr_2016 ?>],
	['May',  <?php echo $num_allegations_may_2013 ?>,      <?php echo $num_allegations_may_2014 ?>,        <?php echo $num_allegations_may_2015 ?>,        <?php echo $num_allegations_may_2016 ?>],
	['Jun',  <?php echo $num_allegations_jun_2013 ?>,      <?php echo $num_allegations_jun_2014 ?>,        <?php echo $num_allegations_jun_2015 ?>,        <?php echo $num_allegations_jun_2016 ?>],
	['Jul',  <?php echo $num_allegations_jul_2013 ?>,      <?php echo $num_allegations_jul_2014 ?>,        <?php echo $num_allegations_jul_2015 ?>,        <?php echo $num_allegations_jul_2016 ?>],
	['Aug',  <?php echo $num_allegations_aug_2013 ?>,      <?php echo $num_allegations_aug_2014 ?>,        <?php echo $num_allegations_aug_2015 ?>,        <?php echo $num_allegations_aug_2016 ?>],
	['Sep',  <?php echo $num_allegations_sep_2013 ?>,      <?php echo $num_allegations_sep_2014 ?>,        <?php echo $num_allegations_sep_2015 ?>,        <?php echo $num_allegations_sep_2016 ?>],
	['Oct',  <?php echo $num_allegations_oct_2013 ?>,      <?php echo $num_allegations_oct_2014 ?>,        <?php echo $num_allegations_oct_2015 ?>,        <?php echo $num_allegations_oct_2016 ?>],
	['Nov',  <?php echo $num_allegations_nov_2013 ?>,      <?php echo $num_allegations_nov_2014 ?>,        <?php echo $num_allegations_nov_2015 ?>,        <?php echo $num_allegations_nov_2016 ?>],
    ['Dec',  <?php echo $num_allegations_dec_2013 ?>,      <?php echo $num_allegations_dec_2014 ?>,         <?php echo $num_allegations_dec_2015 ?>,         <?php echo $num_allegations_dec_2016 ?>]
  ]);
