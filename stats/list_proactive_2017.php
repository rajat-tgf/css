...
$result_proactive_2017 = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE type_allegation = 'Proactive' AND date_received BETWEEN '2017-01-01' AND '2017-12-31' ORDER BY date_received DESC");		
$proactive_2017 = sqlsrv_fetchall($result_proactive_2017);
$num_proactive_2017 = count($proactive_2017);

$total_allegations_involved_2017 = 0;
foreach ($proactive_2017 as $rowallegations2017) {

	$allegation_id = $rowallegations2017['id'];
	$SQL_CHECK_EXIST = sqlsrv_query($conncss, "SELECT * FROM proactive_link WHERE id = '$allegation_id'");
    	$allegations_proactive_2017 = sqlsrv_fetchall($SQL_CHECK_EXIST);
		$num_allegation_involved = count($allegations_proactive_2017);
...
<tr>
<td><strong><font color="#666666" size="+2">Proactive Assessments opened: </font><font size="+2"; color="#990000"><?php echo $num_proactive_2017 ?></strong></font><br />
</td>
</tr>
<tr>
<td align="right"><strong>
<strong><font color="#666666" size="+1">Allegations involved: </font><font size="+1"; color="#990000"><?php echo $total_allegations_involved_2017 ?></strong></font><br />
</td>
</tr>
</table>
...
<?php
//while($rowallegations2017 = sqlsrv_fetch_array($result_proactive_2017)){
	foreach ($proactive_2017 as $rowallegations2017) {	
?>
...
<tr>
    ...
    <img src="../images/Pro-icon1.png" alt="" width="20" height="20" align="top"/>&nbsp;&nbsp;<strong>
        ...
        <font color="#666666">
        <?php
        echo $summary = $rowallegations2017['summary']; ?>
        <br />
        <strong>
        <font color="#666666">
