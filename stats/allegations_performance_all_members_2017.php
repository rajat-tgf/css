...
//HIGH ALLEGATIONS
$result_allegations_high = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE priority = 'High' AND status = 'Closed' AND date_received BETWEEN '2017-01-01' AND '2017-12-31'");		
...
//MIDIUM ALLEGATIONS
$result_allegations_midium = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE priority = 'Medium' AND status = 'Closed' AND date_received BETWEEN '2017-01-01' AND '2017-12-31'");	
...
//LOW ALLEGATIONS
$result_allegations_low = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE priority = 'Low' AND status = 'Closed' AND date_received BETWEEN '2017-01-01' AND '2017-12-31'");
...
$result_rate = sqlsrv_query($conncss, "SELECT * FROM allegation_details LEFT JOIN comments_manager ON allegation_details.id = comments_manager.id WHERE allegation_details.status = 'Closed' AND date_received BETWEEN '2017-01-01' AND '2017-12-31'"); 
