...
$result_allegations_category_Corruption = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'Corruption' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
$num_allegations_category_Corruption = sqlsrv_num_rows($result_allegations_category_Corruption);	

$result_allegations_category_Fraud = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'Fraud' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
$num_allegations_category_Fraud = sqlsrv_num_rows($result_allegations_category_Fraud);

$result_allegations_category_Coercion = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'Coercion' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
$num_allegations_category_Coercion = sqlsrv_num_rows($result_allegations_category_Coercion);

$result_allegations_category_Collusion = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'Collusion' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
$num_allegations_category_Collusion = sqlsrv_num_rows($result_allegations_category_Collusion);

$result_allegations_category_Non_Compliance = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'Non-Compliance with laws / Grant agreements' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
$num_allegations_category_Non_Compliance = sqlsrv_num_rows($result_allegations_category_Non_Compliance);

$result_allegations_category_Human_Rights = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'Human Rights Violations' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
$num_allegations_category_Human_Rights = sqlsrv_num_rows($result_allegations_category_Human_Rights);

$result_allegations_category_JIATF = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'Product Issues (JIATF)' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
$num_allegations_category_JIATF = sqlsrv_num_rows($result_allegations_category_JIATF);

$result_allegations_category_NA = sqlsrv_query($conncss, "SELECT * FROM allegation_details WHERE status = 'Closed' AND category_type = 'N/A' AND date_received BETWEEN '$year-01-01' AND '$year-12-31'", array(), array( "Scrollable" => 'buffered'));		
