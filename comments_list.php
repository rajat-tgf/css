<?php
	...
	$sql_read_comments = "UPDATE comments SET read_notification = 'yes' WHERE allegation_id = '$allegation_id' AND read_notification != 'yes' AND member = '$username'";
...
<?php
 $result_comment = sqlsrv_query($conncss,"SELECT * FROM comments WHERE allegation_id = '$allegation_id' ORDER BY id DESC");
