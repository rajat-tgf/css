...
$result = sqlsrv_query($conncss,"SELECT * FROM checks WHERE type = 'Background Screening'", array(), array( "Scrollable" => 'buffered'));
$num_bs = sqlsrv_num_rows($result);

$result = sqlsrv_query($conncss,"SELECT * FROM checks WHERE type = 'Due Diligence'", array(), array( "Scrollable" => 'buffered'));
$num_dd = sqlsrv_num_rows($result);



$result = sqlsrv_query($conncss,"SELECT * FROM checks WHERE referred = 'Horus'", array(), array( "Scrollable" => 'buffered'));
$num_horus = sqlsrv_num_rows($result);

$result = sqlsrv_query($conncss,"SELECT * FROM checks WHERE referred = 'Secretariat'", array(), array( "Scrollable" => 'buffered'));
$num_sec = sqlsrv_num_rows($result);

$result = sqlsrv_query($conncss,"SELECT * FROM checks WHERE referred = 'Other'", array(), array( "Scrollable" => 'buffered'));
