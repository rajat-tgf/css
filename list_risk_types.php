...
function show_quart_guide(sr){
	parent.show_quart_guide(sr);
};
...
function show_edit_risk_Popup(risk_id){
	   $("#diveditrisk").dialog("open");
	   $("#modalIframeeditrisk").attr("src","edit_risk.php?risk_id=" + risk_id);
	   return false;
	}
...
function showDialogremoverisk(risk_id)
	{
		var risk_id = risk_id;
		

		$("#dialog_delete_risk").dialog(
			{
				width: 400,
				height: 200,
				buttons: {
						"Delete": function() {
							$.post("delete_risk_type.php", {"risk_id": risk_id});
...
$result = sqlsrv_query($conncss,"SELECT * FROM allegation_details WHERE id = '$id'"); 
...
if ( $status == "Screening Review" && $team_member == $username && $submitted_to_officer !== "Yes"){
?>
<table align="left" class="gridtable">
<tr>
<td>
<a style="text-decoration:none" href="" onClick="return show_new_risktype_Popup()"><img src="images/addition-icon.png" width="22" height="22" alt="" align="absmiddle" />&nbsp;Add New</a>
</td>
</tr>
</table><br />
<br />
<?php
    ...
    ?>       
        ...
        <td width="406" valign="top">
          ...
          <strong>Action:&nbsp;&nbsp;</strong><?php echo $action; ?><br />
        ...
        <td width="76" valign="top"><?php
		if ( $status == "Screening Review" && $team_member == $username && $submitted_to_officer !== "Yes"){
		?>
          <a href="#" onclick="return show_edit_risk_Popup(<?php echo $risk_id ?> )">Edit</a><br /><br />

          <a href="delete_risk_type.php?risk_id=<?php echo $risk_id ?>">
          Remove</a>
        <?php } ?>        <div id="dialog_delete_risk" title="Delete Risk Type?" style="display: none;"> <font style="font-size:13px"> Do you want to delete this risk type from the allegation? </font> </div></td>
        </tr>
        </table>
        <br />
   <?php } ?>
   
<div id="divIdnewrisktype" title="Add New">

<form action="save_new_risk_type.php" id="newrisktype" name="newrisktype" method="post" enctype="multipart/form-data">
...
<tr>
  <td colspan="3"><textarea name="description" id="description" style="width:100%" rows="20" class="text ui-widget-content ui-corner-all"></textarea></td>
  </tr>
</table>
 ...
 <div id="diveditrisk" title="Edit Details">
    <iframe id="modalIframeeditrisk" frameborder="0" width="100%" height="100%">
