...
$rowId = 0;
include ("stats/allegations_performance_all_members_2017.php");


$quey1 = "SELECT * FROM allegation_details LEFT JOIN comments_manager ON allegation_details.id = comments_manager.id WHERE allegation_details.status = 'Closed' AND date_received BETWEEN '2017-01-01' AND '2017-12-31' ORDER BY allegation_details.date_received DESC"; 
...
//2017-------------------------------------------------------------------------------------------------------
//HIGH ALLEGATIONS
$result_allegations_high2017 = sqlsrv_query($conncss,"SELECT * FROM allegation_details WHERE team_member = '$requet_member' AND priority = 'High' AND status = 'Closed'".$year."");		



$num_allegations_high2017 = 0;

$total_number_days_screening_high2017 = 0;
$average_high2017 = 0;
while ($row_allegations_high2017 = sqlsrv_fetch_array($result_allegations_high2017)) {	
	$date1 = new DateTime($row_allegations_high2017['date_received']);
	$date2 = new DateTime($row_allegations_high2017['reviewed_by_officer_date']);
	$screening_days = $date2->diff($date1)->format("%a");
	$total_number_days_screening_high2017 = $total_number_days_screening_high2017 + $screening_days;
	$num_allegations_high2017 = $num_allegations_high2017 + 1;
}
if ( $total_number_days_screening_high2017 != 0 && $num_allegations_high2017 != 0 ){
	$average_high2017 = $total_number_days_screening_high2017 / $num_allegations_high2017 ;
	$average_high2017 = round($average_high2017, 0);
}



//MIDIUM ALLEGATIONS
$result_allegations_midium2017 = sqlsrv_query($conncss,"SELECT * FROM allegation_details WHERE team_member = '$requet_member' AND priority = 'Medium' AND status = 'Closed'".$year."");		
$num_allegations_midium2017 = 0;

$total_number_days_screening_medium2017 = 0;
$average_midium2017 = 0 ;
while ($row_allegations_midium2017 = sqlsrv_fetch_array($result_allegations_midium2017)) {	
	$date1 = new DateTime($row_allegations_midium2017['date_received']);
	$date2 = new DateTime($row_allegations_midium2017['reviewed_by_officer_date']);
	$screening_days = $date2->diff($date1)->format("%a");
	$total_number_days_screening_medium2017 = $total_number_days_screening_medium2017 + $screening_days;
	$num_allegations_midium2017 = $num_allegations_midium2017 + 1;
}

if ( $total_number_days_screening_medium2017 != 0 && $num_allegations_midium2017 != 0 ){
	$average_midium2017 = $total_number_days_screening_medium2017 / $num_allegations_midium2017 ;
	$average_midium2017 = round($average_midium2017, 0);
}


//LOW ALLEGATIONS
$result_allegations_low2017 = sqlsrv_query($conncss,"SELECT * FROM allegation_details WHERE team_member = '$requet_member' AND priority = 'Low' AND status = 'Closed'".$year."");		
$num_allegations_low2017 = 0;

$total_number_days_screening_low2017 = 0;
$average_low2017 = 0;
while ($row_allegations_low2017 = sqlsrv_fetch_array($result_allegations_low2017)) {	
	$date1 = new DateTime($row_allegations_low2017['date_received']);
	$date2 = new DateTime($row_allegations_low2017['reviewed_by_officer_date']);
	$screening_days = $date2->diff($date1)->format("%a");
	$total_number_days_screening_low2017 = $total_number_days_screening_low2017 + $screening_days;
	$num_allegations_low2017 = $num_allegations_low2017 + 1;
}
if ( $total_number_days_screening_low2017 != 0 && $num_allegations_low2017 != 0 ){
	$average_low2017 = $total_number_days_screening_low2017 / $num_allegations_low2017 ;
	$average_low2017 = round($average_low2017, 0);
}
?>
    ...
    <div id="entities-contain">
      <table>
        ...
        <tr>
          ...
          <td align="center"><?php echo $num_allegations_high2017 ?></td>
          <td align="center"><?php echo $total_number_days_screening_high2017 ?></td>
          <td align="center"><?php echo $average_high2017 ?></td>
          </tr>
        <tr>
          <td><font color="#FF9933">Medium</font></td>
          <td align="center"><?php echo $num_allegations_midium2017 ?></td>
          <td align="center"><?php echo $total_number_days_screening_medium2017 ?></td>
          <td align="center"><?php echo $average_midium2017 ?></td>
          </tr>
        <tr>
          <td><font color="#009900">Low</font></td>
          <td align="center"><?php echo $num_allegations_low2017 ?></td>
          <td align="center"><?php echo $total_number_days_screening_low2017 ?></td>
          <td align="center"><?php echo $average_low2017 ?></td>
          </tr>
        <tr>
          <td align="center" style="border-top:double"><strong>TOTAL</strong></td>
          <td align="center" style="border-top:double"><strong><?php echo $total_number_allegations2017 = $num_allegations_high2017 + $num_allegations_midium2017 + $num_allegations_low2017 ?></strong></td>
          <td align="center" style="border-top:double"><strong><?php echo $total_number_days2017 = $total_number_days_screening_high2017 + $total_number_days_screening_medium2017 + $total_number_days_screening_low2017 ?></strong></td>
          <td align="center" style="border-top:double"><strong>
            <?php 
	   if ( $total_number_days2017 != 0 && $total_number_allegations2017 != 0 ){
	 echo  $averagetottal2017 = round($total_number_days2017 / $total_number_allegations2017, 0);
	   }else{
		   echo "0";
	   }
	 ?>
       ...
       <td><strong>
         <?php
									...
									if ( $status == "Screening Review" || $status == "Pending finalization"){ 
										...
										?>
										      <td align="center" style="border-top:double"><strong>
											  <?php echo $total_number_days2017 = $total_number_days_screening_high2017 + $total_number_days_s;
