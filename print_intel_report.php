...
<table width="762" align="center">    
<tr><td style="border:none">
<div id="title" align="left">3. OIG comments and assessment</div>
</td></tr>
<tr><td>
...
$result_notes = sqlsrv_query($conncss,"SELECT * FROM notes_ir WHERE report_id = '$id_number'", array(), array( "Scrollable" => 'buffered'));		
$num_notes = sqlsrv_num_rows($result_notes);

$all_rows = sqlsrv_fetchall($result_notes);
