...
echo "</tr>";
			...
			echo "</td>";
			echo "<td>";	
				echo $type_allegation = $row_all['type_allegation'];
			echo "</td>";
			echo "<td>";	
			...
			echo "</td>";
			echo "<td>";
				echo $porfolio_category = $row_all['porfolio_category'];
			echo "</td>";
			echo "<td>";
				echo $coe = $row_all['coe'];
			echo "</td>";
			echo "<td>";
			...
			echo "</td>";
			echo "<td>";
				echo $source_evaluation = $row_all['source_evaluation'];
			echo "</td>";
			echo "<td>";
				echo $intel_evaluation = $row_all['intel_evaluation'];
			echo "</td>";			
			echo "<td>";
