...
//$Security->ValidatePostParams(['id_number', 'team_member']);

$id_number = $_POST['id_number'];
$team_member = $_POST['team_member'];


$sql = "UPDATE allegation_details SET team_member = '$team_member' WHERE id = '$id_number'";
...
if ($result){
	...
	$subject = "OIG CSS - Notification of new Allegation allocated to you";
	...
	$message000 = 'Please note that allegation number ';
	
	$message0000 = ' has been allocated to you for full screening.<br><br>';
	...
	header("location: main.php?allocated='yes'");
