...
<table width="100%" align="center" class="gridtable">
                ...
                <tr>
                  <td colspan="5" align="left" bgcolor="#FFFFFF"><?php echo $request ?></td>
                </tr>
                <tr>
                  <td colspan="5" align="left" bgcolor="#FFFFFF"><strong>Responses / Actions Taken :</strong></td>
                </tr>
                <tr>
                  <td colspan="5" align="left" bgcolor="#FFFFFF"><?php echo $response ?></td>
                </tr>
                <tr>
                  <td width="17%" align="left" bgcolor="#FFFFFF"><strong>Status :</strong></td>
                  <td width="37%" bgcolor="#FFFFFF"><?php echo $status;?>
                   </td>
                  <td width="15%" align="right" bgcolor="#FFFFFF"><strong>Category :</strong></td>
                  <td width="31%" colspan="2" bgcolor="#FFFFFF">
                 <?php echo $category;?>
                  </td>
                </tr>
                <tr>
    ...
    <tr>
      <td valign="top" bgcolor="#FFFFFF"><strong>Comments:</strong></td>
                ...
                <tr>
                  <td colspan="5" valign="top" bgcolor="#FFFFFF"><?php echo $comments ?>
                  </td>
                </tr>
