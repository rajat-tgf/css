...
//Send email to Member
	...
	$subject = "OIG CSS - Notification of Allegation re-allocated to you";
	...
	$message0000 = ' has been allocated to you for screening.';
	...
	header("location: main.php?reallocate='yes'");
}
