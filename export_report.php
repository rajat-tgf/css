...
if ( $month_selected == "January 2017" ){
	$month = "'2017-01-01' AND '2017-01-31'";
}
if ( $month_selected == "February 2017" ){
	$month = "'2017-02-01' AND '2017-02-31'";
}
if ( $month_selected == "March 2017" ){
	$month = "'2017-03-01' AND '2017-03-31'";
}
if ( $month_selected == "April 2017" ){
	$month = "'2017-04-01' AND '2017-04-31'";
}
if ( $month_selected == "May 2017" ){
	$month = "'2017-05-01' AND '2017-05-31'";
}
if ( $month_selected == "June 2017" ){
	$month = "'2017-06-01' AND '2017-06-31'";
}
if ( $month_selected == "July 2017" ){
	$month = "'2017-07-01' AND '2017-07-31'";
}
if ( $month_selected == "August 2017" ){
	$month = "'2017-08-01' AND '2017-08-31'";
}
if ( $month_selected == "September 2017" ){
	$month = "'2017-09-01' AND '2017-09-31'";
}
if ( $month_selected == "October 2017" ){
	$month = "'2017-10-01' AND '2017-10-31'";
}
if ( $month_selected == "November 2017" ){
	$month = "'2017-11-01' AND '2017-11-31'";
}
if ( $month_selected == "December 2017" ){
	$month = "'2017-12-01' AND '2017-12-31'";
}
