...
$( "#add_followup" ).click(function() {
	...
	$(function() {
		...
		$("#buttonhelp9").on("click", function() {
			$("#dialoghelp9").dialog("open");
		});
	});
...
$(function() {
	...
	function show_porfolio_categories() {
			$("#newstyleporfolio").dialog({
			height: 'auto',
			width: '75%',
			resizable: false,
			draggable: false,
			...
			$("#frameporfolio").attr("src", "files/Portfolio_Categorization.pdf");
		}
		
		
		function show_crr_Popup() {
		$("#divIdcrr").dialog({
		height: 800,
		width: 1180,
		resizable: false,
		...
		$("#modalIframeIdcrr").attr("src","files/risk_type.pdf");
 }
...
<table align="center">
    ...
    $result_administrator = sqlsrv_query($conn,"SELECT name FROM screening_officer WHERE name = '$username'", array(), array( "Scrollable" => 'buffered')); 
     ...
     <?php
        ...
        //SEARCH IF THERE IS ANY PROACTIVE LINKED
         ...
         $linkedrows = count($all_linked);
            ...
            ?>
    <tr>
      <td colspan="4"><strong>Title :</strong>
        <input name="summary" type="text" id="summary" style="width:80%"  maxlength="200" value="<?php echo $summary = $row_allegation['summary']; ?>" class="text ui-widget-content ui-corner-all">
      </td>
    </tr>
    <tr>
      <td width="35%"><strong>Priority :
      ...
      <img src="images/question.jpg" width="35" height="35" id="buttonhelp5" align="top" /></strong></td>
      <td width="2%">&nbsp;&nbsp;&nbsp; </td>
      <td width="39%"><strong>Method of referral :
...
&nbsp;&nbsp;&nbsp;<img src="images/question.jpg" width="35" height="35" id="buttonhelp4" align="top" /></strong></td>
      <td width="24%" rowspan="7" align="left"><table align="left">
        <tr>
          <td><strong>Priority :</strong> <?php echo $priority  = $row_allegation['priority'];?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><strong>Date received : </strong><?php echo $date_received_newDate = date('F j, Y', strtotime($row_allegation['date_received']));?></td>
        </tr>
        <tr>
    ...
    <td><strong>Referred from :
      ...
      <tr>
       <td ><strong>Related to previous allegations?
         <select name="previous_allegations" id="previous_allegations" class="text ui-widget-content ui-corner-all">
      ...
      <tr>
           <td valign="top"><strong>Disease area :
             <select name="disease_area" id="disease_area" class="text ui-widget-content ui-corner-all">
           ...
           <td valign="top">&nbsp;</td>
           <td valign="top"><strong><?php echo $source_details = $row_allegation['source_details']; ?></strong></td>
      </tr>
      <tr>
        <td valign="top"><strong>Primary Level of wrongdoing :
        ...
        <td valign="top">&nbsp;</td>
        <td valign="top"><strong>Source Evaluation :
          <select name="source_evaluation" id="source_evaluation" class="text ui-widget-content ui-corner-all">
            <option><?php echo $source_evaluation  = $row_allegation['source_evaluation']; ?></option>
            <option value="Always reliable">Always reliable</option>
            <option value="Mostly reliable">Mostly reliable</option>
            <option value="Sometimes reliable">Sometimes reliable</option>
            <option value="Unreliable">Unreliable</option>
            <option value="Untested source">Untested source</option>
          </select>
      </tr>
      <tr>
        <td valign="top"><strong>Secondary Level of wrongdoing :</strong>
          <select name="wrongdoing3" id="wrongdoing3" class="text ui-widget-content ui-corner-all">
            <option><?php echo $wrongdoing1  = $row_allegation['wrongdoing_level1']; ?></option>
            <option value=""></option>
            <option value="Secretariat">Secretariat</option>
            <option value="CCM">CCM</option>
        ...
        <td valign="top">&nbsp;</td>
        <td valign="top"><strong>Information/Intel Evaluation :
          <select name="intel_evaluation" id="intel_evaluation" class="text ui-widget-content ui-corner-all">
            <option><?php echo $intel_evaluation  = $row_allegation['intel_evaluation']; ?></option>
            <option value="True">True</option>
            <option value="Probably true">Probably true</option>
            <option value="Possibly true">Possibly true</option>
            <option value="Cannot be judged">Cannot be judged</option>
            <option value="Probably false">Probably false</option>
          </select>
      </tr>
      <tr>
        <td valign="top"><strong>Porfolio Categories : 
          <select name="porfolio_category" id="porfolio_category" class="text ui-widget-content ui-corner-all">
            <option><?php echo $porfolio_category  = $row_allegation['porfolio_category']; ?></option>
            <option value="High Impact">High Impact</option>
            <option value="Focus">Focus</option>
            <option value="Core">Core</option>
          </select>
&nbsp;&nbsp;&nbsp; <a href="#" onClick="show_porfolio_categories()"><img src="images/question.jpg" width="35" height="35" align="absmiddle" /></a></strong></td>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
        <td align="left">&nbsp;</td>
      </tr>
      <tr>
        <td valign="top"><strong>Challenging Operating Environment :
            <select name="coe" id="coe" class="text ui-widget-content ui-corner-all">
              <option><?php echo $coe  = $row_allegation['coe']; ?></option>
              <option value="Yes">Yes</option>
              <option value="No">No</option>
            </select>
&nbsp;&nbsp;&nbsp;<img src="images/question.jpg" width="35" height="35" id="buttonhelp9" align="top" /></strong></td>
        <td valign="top">&nbsp;</td>
        <td valign="top">&nbsp;</td>
        <td align="left">&nbsp;</td>
      </tr>
    ...
    <tr>
       <td width="65%" valign="top">
         <iframe src="link_grants_to_allegation.php" align="top" width="100%" height="375" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"> </iframe>
        </td>
    ...
    <?php
        ...
        <?php }else{ ?>
            <iframe src="list_risk_types.php" align="top" width="100%" height="580" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"> </iframe>
        <?php } ?>
    </fieldset>
    </div>
            ...
            <td>
              ...
              <?php $resolution = $row_allegation['resolution'];?>
               ...
               <td>
                ...
                <?php $department = $row_allegation['department'];?>
                ...
                <?php $agency = $row_allegation['agency'];?>
                <option value="<?php echo $agency?>"><?php echo $agency;?></option>
                  <option></option>
                  <option>UNDP</option>
                  <option>USAID</option>
...
<a style="text-decoration:none" href="" onClick="return show_new_note_Popup()"><img src="images/addition-icon.png" width="22" height="22" alt="" align="absmiddle" />&nbsp;Add Note</a>
...
<script>
function show_new_note_Popup(){
   $("#divIdnewnote").dialog("open");
   return false;
}
...
<div id="divIdnewnote" title="Add new note">
<form action="save_new_note.php" id="newnote" name="newnote" method="post">
<div id="notes-contain">
      <table width="100%" border="0" align="center">
          <tr>
            <td width="71" valign="top" bgcolor="#FFFFFF"><strong>Name :</strong></td>
          ...
          <tr>
            ...
            <td width="842" valign="top" bgcolor="#FFFFFF"><input type="text" id="datepickernote"  name="date" class="text ui-widget-content ui-corner-all"/></td>
          </tr>
...
<div id="dialoghelp9" title="Help">
    <font style="font-size:13px">
    A list of 25 countries have been classified as Challenging Operating Environments (COEs) by the Executive Grant Management Committee for the 2017-2019 period. They are:
<p>
<strong>Afghanistan, Burundi, Central African Republic, Chad, *Congo (Democratic Republic), Eritrea, Guinea, Guinea-Bissau, Haiti, Iraq, Lebanon, Liberia, Mali, Mauritania, Niger, *Nigeria, *Pakistan, Palestine, Sierra Leone, Somalia, South Sudan, *Sudan, Syrian Arab Republic, Ukraine, Yemen
</strong>
<p>
*High Impact portfolios
<p>
Depending on emerging needs during the course of the allocation period, adjustments can be made to this COE list, for

    Countries that face sudden emergency situations or disease outbreaks may be considered on a case-by-case basis and categorized as COEs; and
    Post-crisis countries may remain categorized as COEs for one additional allocation period, in order to allow for restoration and strengthening of health systems.
<p>
The countries listed above will also be eligible to access flexibilities to existing policies and procedures throughout the grant lifecycle (including eligibility and grant implementation arrangements), to increase health impact. Further details will be included in the forthcoming OPN on Challenging Operating Environments.
    </font>
</div>
...
<div id="dialog-form-comment" title="Add new comment">
 ...
 <div id="divIdcrr" style="display: none;" title="Corporate Risk Register">
    <iframe id="modalIframeIdcrr" frameborder="0" width="100%" height="100%">
    </iframe>
</div>
...
<div id="newstyleporfolio" style="display: none;" title="Porfolio Categories Guide">
    <iframe id="frameporfolio" frameborder="0" width="100%" height="700">
    </iframe>
</div>
