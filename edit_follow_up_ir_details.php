...
$result_id_follow_up = sqlsrv_query($conncss,"select * from follow_ups_ir WHERE id = '$id_follow_up'"); 
...
<form method="POST" action="modify_details_follow_up_ir.php?id_follow_up=<?php echo $id_follow_up ?>" id="modifyfollowup" name="modifyfollowup" >
  ...
  <table align="center" class="gridtable">
                ...
                <tr>
                  <td colspan="5" align="left" bgcolor="#FFFFFF"><textarea name="request" style="width:100%" rows="5" id="request" class="text ui-widget-content ui-corner-all"><?php echo $request ?></textarea></td>
                </tr>
                <tr>
                  <td colspan="5" align="left" bgcolor="#FFFFFF"><strong>Responses / Actions Taken :</strong></td>
                </tr>
                <tr>
                  <td colspan="5" align="left" bgcolor="#FFFFFF"><textarea name="response" id="response" style="width:100%" rows="5" class="text ui-widget-content ui-corner-all"><?php echo $response ?></textarea></td>
                </tr>
                <tr>
    ...
    <tr>
      <td valign="top" bgcolor="#FFFFFF"><strong>Comments:</strong></td>
                ...
                <tr>
                  <td colspan="5" valign="top" bgcolor="#FFFFFF"><textarea name="comments" id="comments" style="width:100%" rows="5" class="text ui-widget-content ui-corner-all"><?php echo $comments ?></textarea>
